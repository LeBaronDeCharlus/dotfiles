...
local modkey       = "Mod4"
local altkey       = "Mod1"
-- local terminal     = "tabbed -r 2 /home/void/.local/bin/st -w ''"
local terminal     = "tabbed -r 2 .local/bin/st -w  ''"
local editor       = os.getenv("EDITOR") or "nvim" or "vim"
local gui_editor   = "gvim"
--local browser      = "firefox"
local browser      = "/bin/chromium"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "F12", function () awful.util.spawn("sudo zzz") end),
    ...
    awful.key({ modkey,}, "e", function () awful.util.spawn("rofi -modi emoji -show emoji -kb-custom-1 Ctrl+c") end),
    awful.key({ modkey,}, "a", function () awful.util.spawn("/bin/chromium --disable-gpu") end),
    awful.key({ modkey, "Shift" }, "Return", function () awful.util.spawn("/bin/emacsclient -c") end),
...
run_once({"sudo pkill emacs ; /usr/bin/emacs --fg-daemon" })
run_once({"nm-applet"})
run_once({"feh --bg-fill $HOME/.config/awesome/themes/powerarrow-dark/wall.png"})
run_once({"xrandr --output eDP1 --brightness 1"})
run_once({"warpd"})
